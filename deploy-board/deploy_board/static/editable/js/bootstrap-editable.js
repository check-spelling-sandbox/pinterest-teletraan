...
(function ($) {
    ...
    Editable.prototype = {
        ...
        init: function () {
            ...
            //if display is function it's far more convenient to have autotext = always to render correctly on init
            ...
            //depending on autotext run render() or just finalize init
    ...
    $.extend(List.prototype, {
        ...
        onSourceReady: function (success, error) {
            ...
            if ($.isFunction(this.options.source)) {
                ...
                //note: if function returns the same source as URL - sourceData will be taken from cache and no extra request performed
            } else {
